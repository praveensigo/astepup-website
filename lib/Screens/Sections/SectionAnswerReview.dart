...
class SectionAnswerReview extends StatefulWidget {
  const SectionAnswerReview({super.key, required this.sectionId});

  final String sectionId;

  @override
  State<SectionAnswerReview> createState() => _SectionAnswerReviewState();
}

class _SectionAnswerReviewState extends State<SectionAnswerReview> {
  String courseId = getSavedObject(StorageKeys.courseId) ?? "";
  final lessonController = Get.find<LessonController>();
  String moduleId = getSavedObject(StorageKeys.moduleId);
  String stageId = getSavedObject(StorageKeys.stageId);
          ...
          for (int moduleIndex = 0;
            ...
            if (currentModuleId == moduleId) {
              ...
              for (int sectionIndex = 0;
                ...
                if (currentSectionId == widget.sectionId) {
    ...
    return GetBuilder<QuizController>(
      ...
      builder: (controller) {
        return ReviewAnswerWidget(
          ...
          currentQuiz: CurrentQuiz.section,
          ...
          retake: '/lesson/section/${widget.sectionId}',
          feedbackWidget: () {
